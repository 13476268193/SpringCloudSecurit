...
import com.securit.core.util.WebUtils;
...
//				.getBeansOfType(UserDetailsService.class);
		userDetailsService = SpringUtil.getBean(UserDetailsService.class);
	...
	/*public static void main(String[] args) {
		String pwd = PasswordEncoderFactories.createDelegatingPasswordEncoder().encode("123456");
