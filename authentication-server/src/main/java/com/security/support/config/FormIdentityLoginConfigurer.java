...
import com.security.support.handler.FormAuthenticationFailureHandler;
import com.security.support.handler.SsoLogoutSuccessHandler;
...
public final class FormIdentityLoginConfigurer
    ...
    public void init(HttpSecurity http) throws Exception {
        http.formLogin(formLogin -> {
                    ...
                    formLogin.loginProcessingUrl("/oauth2/consent");
